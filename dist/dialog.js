...
/******/ 	var hotCurrentHash = "ab49f33fe1c9eb2528a1"; // eslint-disable-line no-unused-vars
...
var Dialog = function Dialog(options) {
  ...
  var initialize = function initialize() {
    ...
    if (options.addClass !== null) {
      _Tools.default.addClass(div, options.addClass);
    }
...
var Options = function Options(options) {
  ...
  this.title = 'Dialog Box'; /// Any added class
  ...
  this.titleBarButtons = null; /// Array of buttons for the bottom.
  /// If null, a close button is added automatically.
  /// Otherwise, an array of objects, with these fields:
